                ...
                <x-dropdown align="right" width="64">
                    ...
                    <x-slot name="content">
                        ...
                        @forelse(Auth::user()->unreadNotifications as $notification)
                            <x-dropdown-link href="{{ route('products.edit', $notification->data['product_id']) }}">
                                <div class="font-bold text-red-600">{{ $notification->data['product_name'] }} - Low Stock!</div>
                                <div class="text-sm">Quantity: {{ $notification->data['quantity'] }} (Min: {{ $notification->data['min_stock'] }})</div>
